...
WHERE (motebehov_ubehandlet OR moteplanlegger_ubehandlet OR oppfolgingsplan_lps_bistand_ubehandlet OR dialogmotekandidat OR (aktivitetskrav = 'NY' OR aktivitetskrav = 'AVVENT'));
