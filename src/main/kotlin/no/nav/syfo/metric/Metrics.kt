...
const val OVERSIKTHENDELSE_MOTEBEHOV_SVAR_MOTTATT = "oversikthendelse_motebehov_svar_mottatt_count"
...
val COUNT_OVERSIKTHENDELSE_MOTEBEHOV_SVAR_MOTTATT: Counter = Counter.build()
        .namespace(METRICS_NS)
