...
const val OVERSIKTHENDELSE_MOTEBEHOV_SVAR_MOTTATT_OPPDATER_ENHET = "${OVERSIKTHENDELSE_MOTEBEHOV_SVAR_MOTTATT_BASE}_oppdater_enhet_count"

const val OVERSIKTHENDELSE_MOTEBEHOV_SVAR_BEHANDLET_BASE = "${METRICS_NS}_oversikthendelse_motebehov_svar_behandlet"
const val OVERSIKTHENDELSE_MOTEBEHOV_SVAR_BEHANDLET = "${OVERSIKTHENDELSE_MOTEBEHOV_SVAR_BEHANDLET_BASE}_count"
const val OVERSIKTHENDELSE_MOTEBEHOV_SVAR_BEHANDLET_OPPDATER_ENHET = "${OVERSIKTHENDELSE_MOTEBEHOV_SVAR_BEHANDLET_BASE}_oppdater_enhet_count"
...
const val OVERSIKTHENDELSE_MOTEPLANLEGGER_ALLE_SVAR_MOTTATT_OPPDATER_ENHET = "${OVERSIKTHENDELSE_MOTEPLANLEGGER_ALLE_SVAR_MOTTATT_BASE}_oppdater_enhet_count"
...
const val OVERSIKTHENDELSE_MOTEPLANLEGGER_ALLE_SVAR_BEHANDLET_OPPDATER_ENHET = "${OVERSIKTHENDELSE_MOTEPLANLEGGER_ALLE_SVAR_BEHANDLET_BASE}_oppdater_enhet_count"
...
val COUNT_OVERSIKTHENDELSE_MOTEBEHOV_SVAR_MOTTATT_OPPDATER_ENHET: Counter =
    Counter.builder(OVERSIKTHENDELSE_MOTEBEHOV_SVAR_MOTTATT_OPPDATER_ENHET)
        .description("Counts the number of oversikthendelse of type motebehovsvar-mottatt resulting in update with new enhetId}")
        .register(METRICS_REGISTRY)

val COUNT_OVERSIKTHENDELSE_MOTEBEHOVSSVAR_BEHANDLET: Counter =
    Counter.builder(OVERSIKTHENDELSE_MOTEBEHOV_SVAR_BEHANDLET)
        .description("Counts the number of oversikthendelse of type motebehovsvar-behandlet resulting in update")
        .register(METRICS_REGISTRY)

val COUNT_OVERSIKTHENDELSE_MOTEBEHOVSSVAR_BEHANDLET_OPPDATER_ENHET: Counter =
    Counter.builder(OVERSIKTHENDELSE_MOTEBEHOV_SVAR_BEHANDLET_OPPDATER_ENHET)
        .description("Counts the number of oversikthendelse of type motebehovsvar-behandlet resulting in update with new enhetId")
        .register(METRICS_REGISTRY)
...
val COUNT_OVERSIKTHENDELSE_MOTEPLANLEGGER_ALLE_SVAR_MOTTATT_OPPDATER: Counter =
    Counter.builder(OVERSIKTHENDELSE_MOTEPLANLEGGER_ALLE_SVAR_MOTTATT_OPPDATER)
        ...
        .register(METRICS_REGISTRY)
val COUNT_OVERSIKTHENDELSE_MOTEPLANLEGGER_ALLE_SVAR_MOTTATT_OPPDATER_ENHET: Counter =
    Counter.builder(OVERSIKTHENDELSE_MOTEPLANLEGGER_ALLE_SVAR_MOTTATT_OPPDATER_ENHET)
        .description("Counts the number of oversikthendelse of type moteplanlegger-alle-svar-mottatt resulting in update with new enhetId}")
        .register(METRICS_REGISTRY)
...
val COUNT_OVERSIKTHENDELSE_MOTEPLANLEGGER_ALLE_SVAR_BEHANDLET_OPPDATER: Counter =
    Counter.builder(OVERSIKTHENDELSE_MOTEPLANLEGGER_ALLE_SVAR_BEHANDLET_OPPDATER)
        ...
        .register(METRICS_REGISTRY)
val COUNT_OVERSIKTHENDELSE_MOTEPLANLEGGER_ALLE_SVAR_BEHANDLET_OPPDATER_ENHET: Counter =
    Counter.builder(OVERSIKTHENDELSE_MOTEPLANLEGGER_ALLE_SVAR_BEHANDLET_OPPDATER_ENHET)
        .description("Counts the number of oversikthendelse of type moteplanlegger-alle-svar-behandlet resulting in update with new enhetId}")
        .register(METRICS_REGISTRY)
