...
import no.nav.syfo.infrastructure.COUNT_KAFKA_CONSUMER_PDL_PERSONHENDELSE_UPDATES
import no.nav.syfo.infrastructure.database.DatabaseInterface
import no.nav.syfo.infrastructure.database.queries.updatePersonOversiktStatusNavnToNull
