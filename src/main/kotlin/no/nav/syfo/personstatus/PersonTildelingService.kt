...
class PersonTildelingService(private val database: DatabaseInterface) {
    ...
    fun lagreKnytningMellomVeilederOgBruker(veilederBrukerKnytninger: List<VeilederBrukerKnytning>) = veilederBrukerKnytninger.map { database.lagreVeilederForBruker(it) }
}
