...
class AktivitetskravVurderingConsumerTest {
    ...
    private val kafkaAktivitetskravVurderingNy = generateKafkaAktivitetskravVurdering(status = AktivitetskravStatus.NY, isFinal = false)
    private val kafkaAktivitetskravVurderingAvventer = generateKafkaAktivitetskravVurdering(
    ...
    private val aktivitetskravVurderingNy = generateKafkaAktivitetskravVurdering(
        status = AktivitetskravStatus.NY,
        isFinal = false,
    )
    private val aktivitetskravVurderingOppfylt = generateKafkaAktivitetskravVurdering(
